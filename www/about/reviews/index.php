...
$APPLICATION->SetPageProperty("keywords", "Отзывы товаров Товаров.ТОП, Отзывы товаров Tovarov.TOP");
$APPLICATION->SetPageProperty("description", "Отзывы реальных покупателей о товарах интернет-магазина Товаров.Топ.");
