...
$arComponentParameters["PARAMETERS"]["ES_SHOW_MAX_GROUP_COUNT"] = array(
	"PARENT" => "ES_SETTING_CATALOG",
	"NAME" => GetMessage("ES_SHOW_MAX_GROUP_COUNT"),
	"TYPE" => "STRING",
	"DEFAULT" => "1",
);
...
if(intval($arCurrentValues["ES_IBLOCK_CATALOG"]) > 0 && intval($arCurrentValues["ES_IBLOCK_GROUP"]) > 0)
{
	...
	while($obElement = $rsElements->GetNextElement())
	{
		...
		$arComponentParameters["GROUPS"]["ES_GROUP_".$arItem["CODE"]] = array("NAME" => GetMessage("ES_GROUP").": ".$arItem["NAME"], "SORT" => $esSectSort++);
		$arComponentParameters["PARAMETERS"]["ES_GROUP_".$arItem["CODE"]] = array(
			"PARENT" => "ES_GROUP_".$arItem["CODE"],
