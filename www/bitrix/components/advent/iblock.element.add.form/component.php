<?
    ...
    {
        // process POST data
        if (check_bitrix_sessid() && (!empty($_REQUEST["iblock_submit_c"]) || !empty($_REQUEST["iblock_apply"])))
        {
                ...
                {  
                    ...
                    } else
                    {
                        ...
                        $arFields = Array(                            
                            ...
                            "PREVIEW_TEXT" => $arUpdateValues['PREVIEW_TEXT'],
                        );
                    }
            ...
            if (count($arResult["ERRORS"]) == 0)
            {
                ...
                $sRedirectUrl .= (strpos($sRedirectUrl, "?") === false ? "?" : "&")."strIMessage_c=";
        ...
        if ($bShowForm)
        {
            ...
            $arResult["MESSAGE"] = htmlspecialcharsex($_REQUEST["strIMessage_c"]);
