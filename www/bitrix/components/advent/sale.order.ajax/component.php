			...
			if($USER->IsAuthorized() && empty($arResult["ERROR"]))
			{
				...
				if (empty($arResult["ERROR"]))
				{
					...
					$arFields = Array(
                        ...
                        "SHOP_ADDRESS" =>file_get_contents($_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/include_areas/address.php'),
                        "SHOP_EMAIL" =>file_get_contents($_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/include_areas/email.php'),
                        "SHOP_SKYPE" =>file_get_contents($_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/include_areas/skype.php'),
                        "SHOP_PHONE" =>file_get_contents($_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/include_areas/phone.php'),
                        "SHOP_SOCIAL"=>$social,
					);
