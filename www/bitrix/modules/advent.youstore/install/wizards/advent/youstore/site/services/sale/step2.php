...
if(IntVal($userGroupID) > 0)
{
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/blog/"), Array($userGroupID => "W"));
...
COption::SetOptionString("youstore", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>