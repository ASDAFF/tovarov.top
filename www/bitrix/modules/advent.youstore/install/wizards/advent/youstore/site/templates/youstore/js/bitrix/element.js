...
window.JCCatalogElement.prototype.ChangeInfo = function()
{
    ...
    if (-1 < index)
    {
        if (!!this.obPrice.price)
        {
            ...
            ////console.log(BX.message("CURRENCY_RUB_TITLE"));
            BX.adjust(this.obPrice.price, {html: this.offers[index].PRICE.DISCOUNT_VALUE + " <sub>"+this.pickedCurrency+"</sub>"});
            //BX.adjust(this.obPrice.price, {html: this.offers[index].PRICE.DISCOUNT_VALUE + " <sub>"+BX.message("HEADER_SECS")+"</sub>"});
