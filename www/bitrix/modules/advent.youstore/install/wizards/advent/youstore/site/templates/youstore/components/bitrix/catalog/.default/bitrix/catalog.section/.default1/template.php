                    ...
                    <div class="holder">
                        <?if(!empty($arItem["PROPERTIES"]["DAY_ITEM"]["VALUE"])):?>
                            <div class="strong-box">
                                <strong><?=GetMessage("CT_BCS_TPL_MESS_BTN_DAYOFFER")?></strong>
                            </div>
                        <?endif?>
                        <?
                        ...
                        <?endif?>
                            <div class="image">
                                <a id="<? echo $arItemIDs['PICT']; ?>"
                                    ...
                                    <a href="<?=SITE_DIR?>ajax/quick.php?ID=<?=$arItem["ID"]?>" class="quick-view" rel="nofollow"><?=GetMessage('CT_BCS_TPL_MESS_QUICK')?></a>
                                </a>
                            </div>
                            <div class="title">
                                <h3>
                            ...
                            <div class="expand">
                                <div class="expand-holder">
                                    ...
                                    if (!empty($arItem['MIN_PRICE'])/* && $arItem['CAN_BUY']*/)
                                    {
                                        ...
                                        {
                                            ?>
                                            <p class="message"><?=GetMessage('ECONOM')?><strong><?=$arItem['MIN_PRICE']["DISCOUNT_DIFF"]?></strong> <sub><?=GetMessage("CURRENCY_".$arItem["MIN_PRICE"]["CURRENCY"]."_TITLE")?></sub>.</p>
                                            <?
                                        }
                                    }?>
                                    <ul class="tools">
                                        <li class="like"><a class="link-wishlist" href="<?=SITE_DIR?>ajax/wishlist.php?action=LIKE&ID=<?=$arItem["ID"]?>"><?=GetMessage('CT_BCS_TPL_MESS_WISH')?></a></li>
                                        <li class="compare"><a class="link-compare" href="<?=SITE_DIR?>ajax/compare.php?id=<?=$arItem["ID"]?>&action=ADD_TO_COMPARE_LIST"><?=GetMessage('CT_BCS_TPL_MESS_BTN_COMPARE')?></a></li>
                                    </ul>
