...
<?if($arParams["SHOW_VOTE_COUNT"] == "Y"):?>
	<span>(<s class="vc" style="float:none;clear:both;line-height: 21px;"><?=intval($arResult["PROPERTIES"]["vote_count"]["VALUE"])?></s> <?=GetMessage("VOTES")?>)</span>
<?endif?>
