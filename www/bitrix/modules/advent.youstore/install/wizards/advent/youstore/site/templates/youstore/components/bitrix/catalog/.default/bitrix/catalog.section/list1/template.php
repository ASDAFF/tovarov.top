                ...
                <div id="<? echo $strMainID; ?>" class="item mix <?if(!empty($arItem["PROPERTIES"]["DAY_ITEM"]["VALUE"])):?>day-item<?endif?> category-<?=$arItem["PROPERTIES"]["SEX"]["VALUE_ENUM_ID"]?> <?if(!$arItem["CAN_BUY"]):?>unavailable<?endif?>">
                    <div class="holder">
                        ...
                        <?if(!empty($arItem["PROPERTIES"]["YOUTUBE_VIDEO"]["VALUE"])):?>
                            <a href="<?=$arItem["PROPERTIES"]["YOUTUBE_VIDEO"]["VALUE"]?>" class="video-link">play</a>
                        <?endif?>
                            <div class="image">
                                <a id="<? echo $arItemIDs['PICT']; ?>"
                                    ...
                                    <span href="<?=SITE_DIR?>ajax/quick.php?ID=<?=$arItem["ID"]?>" class="quick-view" rel="nofollow"><?=GetMessage('CT_BCS_TPL_MESS_QUICK')?></span>
                                </a>
                            </div>
                            <div class="text">
                                <div class="title">
                                ...
                                ?>
                                <a href="<?=SITE_DIR?>ajax/wishlist.php?action=LIKE&ID=<?=$arItem["ID"]?>" class="link-heart link-wishlist"><?=GetMessage('CT_BCS_TPL_MESS_ADDWISH')?></a>
                            </div>
                            <?
