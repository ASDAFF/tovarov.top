			...
			{		
				...
				if ('TEXT' == $arProp['SHOW_MODE'])
				{
					...
					?>
							...
							<div class="memory-holder">
								...
								<span class="select">
									...
									<ul style="display:none" id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_list">
										<?
											$input_val = GetMessage('CT_BCE_CATALOG_NOT_SELECTED');
											$i = 0;
						...
						<?/*
						<div id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_cont" style="display:none">
							<div class="bx_size_scroller_container">
								<div class="bx_size">
									
									<ul id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_list" style="display:none">
										<?
											foreach ($arProp['VALUES'] as $arOneValue)
											{
												?>
