...
foreach($arResult["ITEMS"] as $arItem){
	if(!empty($arItem["PROPERTIES"][$arParams["TABS_PROPERTY"]]["VALUE"])){
		$tabs[$arItem["PROPERTIES"][$arParams["TABS_PROPERTY"]]["VALUE_ENUM_ID"]?:$arItem["PROPERTIES"][$arParams["TABS_PROPERTY"]]["VALUE"]] = $arItem["PROPERTIES"][$arParams["TABS_PROPERTY"]];
	}
}

$arResult["TABS"] = $tabs;//array_unique($tabs);
?>