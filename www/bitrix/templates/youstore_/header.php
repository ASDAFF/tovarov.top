<?
$isMainPage = $APPLICATION->GetCurDir() != SITE_DIR;
/**
 * @author
 * @email
...
<head>
    ...
    <link media="all" rel="stylesheet" type="text/css"
          href="<?= SITE_TEMPLATE_PATH ?>/css/jquery.mCustomScrollbar.css"/>
        ...
        <div class="w2">
            <div class="outer-wrapper">
                <noindex>
                    <div class="toolbox">
                        <div class="holder">
                            <a rel="nofollow" href="#" class="link-up"
                               style="display: none;"><span><?= GetMessage('UP') ?></span></a>
                            ...
                            <a rel="nofollow" href="#" class="btn-plus"
                               style="display: none;"><span><?= GetMessage('PLUS') ?></span></a>
                        </div>
                    </div>
                </noindex>
					...
					"ALLOW_MULTI_SELECT" => "N"
                                ...
                                <div class="top-info">
                                    <div class="box call">
                                        <strong class="phone" itemprop="telephone"> <?
                                            ...
                                            ?>  </strong>
                                        <a rel="nofollow" href="/ajax/callback.php"
                                           class="callback callback-popup-link"><?= GetMessage('HEADER_CALLBACK') ?></a>
                                    </div>
                                    <div class="box clock">
                                        <?
                                        // âêëþ÷àåìàÿ îáëàñòü äëÿ ðàçäåëà
                        ...
                        <div class="nav-holder">
                            <div class="nav-frame">
                                ...
                                <a href="<?= SITE_DIR ?>about/actions/"
                                   class="discount-link"><?= GetMessage('HEADER_ACTIONS') ?></a>
                                <noindex>
                            ...
                            <div class="page-map" style="margin-top:0;">
                                ...
                                <div class="page-image">
                                    <? if ($APPLICATION->GetProperty("page-image")): ?>
                                        <img alt="image" src="<?= $APPLICATION->ShowProperty("page-image") ?>"
                                             id="page-image"/>
                                    <? else: ?>
                                        <img alt="image"
                                             src="<?= SITE_TEMPLATE_PATH ?>/images/breadcrumbs-images/img-paints.jpg"
                                             id="page-image"/>
                                    <? endif; ?>
                                    <? endif ?>
