...
?>
<div class="wish">
	<a class="link-wish" id="<?echo $arJSParams["ID"]?>" class="<?if($arResult["ELEMENT_EXISTS"] == "Y"):?>exists<?endif?>" href="javascript:void(0)"><?=$arParams["ABOUT_TEXT"]?></a>
	<script src="<?=$templateFolder?>/module.js"></script>
	<link rel="stylesheet" href="<?=$templateFolder?>/styles.css" />
	<script>
		BX.ready(function(){
