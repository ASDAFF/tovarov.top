...
?>
            ...
            foreach ($arResult['ITEMS'] as $key => $arItem)
            {
                ...
                <div id="<? echo $strMainID; ?>" class="item mix <?if(!empty($arItem["PROPERTIES"]["DAY_ITEM"]["VALUE"])):?>day-item<?endif?> category-<?=$arItem["PROPERTIES"]["SEX"]["VALUE_ENUM_ID"]?> <?if(!$arItem["CAN_BUY"]):?>unavailable<?endif?>">
                    <div class="holder">
                        <?/*if(!.default($arItem["PROPERTIES"]["DAY_ITEM"]["VALUE"])):?>
                        ...
                        <?endif?>
                            <div class="image">
                                <a id="<? echo $arItemIDs['PICT']; ?>"
                                    ...
                                    <span href="<?=SITE_DIR?>ajax/quick.php?ID=<?=$arItem["ID"]?>" class="quick-view" rel="nofollow"><?=GetMEssage('CATALOG_QUICK')?></span>
                                </a>
                            </div>
                            <div class="text">
                                <div class="title">
                                ...
                                <div class="stars" style="width: 60px;">
                                ...
                                ?>
                                <a data-id="<?=$arItem['ID']?>" data-action="ADD2DELAY" href="<?=SITE_DIR?>ajax/wishlist.php?action=LIKE&ID=<?=$arItem["ID"]?>" class="link-heart link-wishlist item<?=$arItem['ID']?>"><?=GetMessage('CATALOG_ADDWISH')?></a>
                                <a data-id="<?=$arItem['ID']?>" data-action="DELETE_FROM_DELAY"  href="<?=SITE_DIR?>ajax/wishlist.php" class="link-heart link-wishlist-delete item<?=$arItem['ID']?>" style="display: none;"><?=GetMessage('WISHLIST_DEL')?></a>
