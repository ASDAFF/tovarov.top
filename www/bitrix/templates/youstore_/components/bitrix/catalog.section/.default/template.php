                    ...
                    <?endif;?>
                        ...
                        <ul class="tools">
                            <li>
                                ...
                                <a data-id="<?=$arItem['ID']?>" data-action="DELETE_FROM_DELAY"  href="<?=SITE_DIR?>ajax/wishlist.php" class="link-wishlist-delete item<?=$arItem['ID']?>" style="display: none;"><?=GetMessage('WISHLIST_DEL')?></a>
                            </li> 
                        </ul>
