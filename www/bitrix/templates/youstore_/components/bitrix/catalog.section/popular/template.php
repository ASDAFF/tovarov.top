...
<?
    ...
    <div class="index-products">
        <div class="filters">
            <h2><?=GetMEssage('CATALOG_POPULAR')?></h2>
            <ul class="filters-list">
                <li><a class="filter active" data-filter="all"><?=GetMEssage('CATALOG_ALL')?></a></li>
                <?foreach($arResult["SEX"] as $i => $v):?>
                    <li><a class="filter" data-filter=".category-<?=$v["VALUE_ENUM_ID"]?>"><?=$v["VALUE"]?></a></li>
                    <?endforeach;?>
            </ul>
        </div>
        <div class="products-block">
            ...
            <?
                ...
                $APPLICATION->IncludeFile(SITE_DIR."include/parts/main-right-banners.php", Array(), Array(
                        ...
                        "NAME"      => "Banners",// текст всплывающей подсказки на иконке
