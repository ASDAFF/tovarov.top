...
<div class="tab-content">
	...
	<?
			...
			{
	?>
						<li data-value="<? echo $arOnePhoto['ID']; ?>" style="width: <? echo $strOneWidth; ?>; padding-top: <? echo $strOneWidth; ?>;"><span class="cnt"><img rel="item-images" src="<? echo $arOnePhoto['SRC']; ?>" /><?/*<span class="cnt_item" style="background-image:url('<? echo $arOnePhoto['SRC']; ?>');"></span>*/?></span></li>
	<?
			}
			unset($arOnePhoto);
	?>
	...
	<?
				...
				{
	?>
						<li data-value="<? echo $arOneOffer['ID'].'_'.$arOnePhoto['ID']; ?>" style="width: <? echo $strOneWidth; ?>; padding-top: <? echo $strOneWidth; ?>"><span class="cnt"><img class="fancybox-mini" rel="item-images" src="<? echo $arOnePhoto['SRC']; ?>" /><?/*<span class="cnt_item" style="background-image:url('<? echo $arOnePhoto['SRC']; ?>');"></span>*/?></span></li>
	<?
				}
				unset($arOnePhoto);
	?>
