<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();	
	global $APPLICATION;
	$APPLICATION->SetPageProperty("prop-h1", GetMessage('COMPARE_TITLE'));
	$APPLICATION->AddChainItem(GetMessage('COMPARE_TITLE'));
?>
	...
	<div class="two-columns">
		<div id="sidebar">
			<?
				...
				$APPLICATION->IncludeFile(SITE_DIR."include/right_prev_list.php", Array(), Array(
