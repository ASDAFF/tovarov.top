...
<div class="page-main">
    ...
    if (\Bitrix\Main\Loader::includeModule("iblock")) {
        ...
        if ($obCache->InitCache(36000, serialize($arFilter), "/iblock/catalog")) {
            ...
            $arCurSection = array();
            $dbRes = CIBlockSection::GetList(array(), $arFilter, array("ELEMENT_SUBSECTIONS" => "N", "CNT_ALL" => "N", "CNT_ACTIVE" => "Y"), array("ID", "NAME", "DEPTH_LEVEL", "IBLOCK_SECTION_ID", "DESCRIPTION", "UF_*"));
    ...
    <? endif ?>
        ...
        <div id="content">
            ...
            <div class="products-content">
                <div
                    class="<?= ($show == "" ? "items-cells" : (($show == "table") ? "products-items-listview" : "products-items-list")) ?>">
                    <?
                    $intSectionID = 0;
