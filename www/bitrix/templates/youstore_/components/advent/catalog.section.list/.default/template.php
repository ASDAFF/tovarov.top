...
<div class="cats-filter">
    <h2 class="side-title"><?=GetMessage('CT_CATEGORIES')?></h2>
    <ul class="cats-list">
		<?if($arParams["SHOW_ALL"] == "Y"):?>
			<li <?if(empty($arParams["ACTIVE_SECTION_ID"])):?>class="active"<?endif?>>
				<a href="<?=$APPLICATION->GetCurPageParam("SECTION_ID=", array("SECTION_ID", "PAGEN_3", "SIZEN_3", "arrFilter_P1_MIN", "arrFilter_P1_MAX"))?>"><?=GetMessage('CT_CATEGORIES_ALL')?></a>
			</li>
		<?endif?>
        <?
